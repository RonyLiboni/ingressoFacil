...
public class EventoService {
	...
	public void popularBancoComEventos(CasaDeShow casaDeShow) {
		...
		evento.setQuantidadeIngressosVendidos(evento.getQuantidadeIngressos());
		salvar(evento);
		...
		evento2.setImagemDoEvento("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQIteUsB-YQMuF9KOL5afdKTLFbevSK3q0_nQ&usqp=CAU");
		...
		evento3.setImagemDoEvento("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ7TVxa2MBNOTlINqrUgIZpGthT7NUqgGk4Rg&usqp=CAU");
		...
		evento5.setImagemDoEvento("https://upload.wikimedia.org/wikipedia/pt/thumb/8/8f/Kisses_-_Anitta.png/220px-Kisses_-_Anitta.png");
